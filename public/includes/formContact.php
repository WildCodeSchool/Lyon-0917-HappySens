...
<form method="post"  action="../includes/validFormContact.php" class="col s6">
    ...
    <div class="row">
        <div class="input-field col s12 m6">
            <input placeholder="ex: martin" id="first_name" type="text" class="validate" name="first_name"
                   value="<?php echo isset($_SESSION['inputs']['first_name']) ? $_SESSION['inputs']['first_name'] : ""; ?>" required>
            <label for="first_name">Prénom</label>
        </div>
        <div class="input-field col s12 m6">
            <input id="last_name" type="text" class="validate" placeholder="ex: Dupond" name="last_name"
    ...
    <div class="row">
        <div class="input-field col s12">
            <input id="company_name" type="text" class="validate" placeholder="ex: Happy Sens" name="company_name"
